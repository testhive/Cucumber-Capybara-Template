...
if cucumber features/regression BROWSER=${browser} -t ~@wip -f pretty -f html -o build/reports/report.html -f junit -o build/reports/junit -f rerun  -o rerun.txt ; then
